...
def main(file_name, turns):
    ...
    for blueprint, requirements in blueprints.items():
        ...
        max_turn, i = 4, 1
        while heap:
            if heap and heap[0][0] > max_turn:
                max_turn = turn
                if heap and len(heap) > 10000:
            ...
            for station in factory:
                ...
                if station == 'None':
                    ...
                    if turn < turns:
                        order = (-new_robots['ge'], -new_inv['ge'],
                                 -new_robots['ob'], -new_inv['ob'],
                                 -new_robots['cl'], -new_inv['cl'],
                                 -new_robots['or'], -new_inv['or'])
...
@time_this
def time_trial(func, rounds):
    func("AOC22_D19_inp.txt", rounds)


if __name__=='__main__':
    geodes = main("AOC22_D19_inp.txt", 32)
    print(geodes)
    a,b,c = geodes['blueprints'][1], geodes['blueprints'][2], \
        geodes['blueprints'][3]
    print(a, b, c)
    print(a*b*c)

    print(f'Time trial: {time_trial(main, 32)} seconds')
